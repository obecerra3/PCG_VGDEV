...
public class CMesh {
    ...
    //give a cmesh multiple points of access, always a centroid, but you can include points of interest like beak tip, claws, this can be abstracted away from
    //programmer choice to user choice (spore)
    ...
    public void addToMesh() {
        mesh.vertices = geo_table.ToArray();
        mesh.uv = uvs.ToArray();
        mesh.triangles = triangle_table.ToArray();
